...
type AssessmentQuestion struct {
	...
	// Keeping generic 'question' for backward compat or default
...
type AssessmentQuestionOption struct {
	...
	OptionTextEn string  `gorm:"column:option_text_en" json:"option_text_en"`
	OptionTextTa *string `gorm:"column:option_text_ta" json:"option_text_ta"`
